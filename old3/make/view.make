...
ocamlopt -I ../../bin -for-pack View -c runtimeModeKindExt.mli
ocamlopt -I ../../bin -for-pack View -c runtimeModeKindExt.ml
...
ocamlopt -I ../../bin -for-pack View -c sideExt.mli
ocamlopt -I ../../bin -for-pack View -c sideExt.ml
...
ocamlopt -for-pack View -c tissueFrame.ml
ocamlopt -I ../../bin -for-pack View -c tissue.mli
...
callStackPointColorScheme.cmx image.cmx runtimeModeKindExt.cmx \
stateUpdatableResult.cmx IMAGES_PROVIDER.cmx imagesStorage.cmx \
imagesProvider.cmx const.cmx sideExt.cmx scale.cmx pair.cmx \
cellElementPrinter.cmx tissueFrame.cmx tissue.cmx
